...
using SDP211_Web_API;
using SDP211_Web_API.Data;
...
namespace ExampeSDP211.Controllers
{
    ...
    {
        private readonly SDP211_Web_APIContext _context;

        public WeatherForecastsController(SDP211_Web_APIContext context)
        {
            _context = context;
        }
